...
<head>
  ...
  <title>ESRN Nº 25 | Chimpay</title>
  ...
  if (isset($_SESSION["iniciarSesion"]) && $_SESSION["iniciarSesion"] == "ok") {
    ...
    if(isset($_GET["ruta"])){
      ...
      if ($_GET["ruta"] == "inicio" ||
          ...
          $_GET["ruta"] == "52tm-eve" ||
          $_GET["ruta"] == "51tt-eve" ||              
          $_GET["ruta"] == "3-principio-economia" ||
          $_GET["ruta"] == "4-economia-economia" ||
          $_GET["ruta"] == "4-principio-economia" ||
          $_GET["ruta"] == "4-pymes-economia" ||
          $_GET["ruta"] == "3-sistemas-informatica" ||
          $_GET["ruta"] == "4-aplicaciones-informatica" ||
          $_GET["ruta"] == "4-conectividad-informatica" ||
          $_GET["ruta"] == "5-pymes-economia" ||
          $_GET["ruta"] == "5-problematicas-economia" ||
          $_GET["ruta"] == "5-taller-economia" ||
