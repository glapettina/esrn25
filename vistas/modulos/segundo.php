                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                              ...
                              if ($value["estado"] != 0) {
                                ...
                                echo '<td><button class="btn btn-success btn-xs btnActivarAlumno" tabla="segundo" idAlumno="'.$value["id"].'" estadoAlumno="0">Activado</button></td>';

                            }else{

                                echo '<td><button class="btn btn-danger btn-xs btnActivarAlumno" tabla="segundo" idAlumno="'.$value["id"].'" estadoAlumno="1">Desactivado</button></td>';
                            }
                          ...
                          echo '<td>
                            ...
                            if ($_SESSION["perfil"] != "Preceptor") {
                              ...
                              echo'<button class="btn btn-primary btnImprimirInformeCb" informe="informecb" periodo="'.$_SESSION['periodo'].'" tabla="segundo" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirInformeCb"><i class="fa fa-print"></i></button>
