                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                              ...
                              if ($value["estado"] != 0) {
                                ...
                                echo '<td><button class="btn btn-success btn-xs btnActivarAlumno" tabla="quinto" idAlumno="'.$value["id"].'" estadoAlumno="0">Activado</button></td>';

                            }else{

                                echo '<td><button class="btn btn-danger btn-xs btnActivarAlumno" tabla="quinto" idAlumno="'.$value["id"].'" estadoAlumno="1">Desactivado</button></td>';
                            }
                          ...
                          echo '<td>
                            ...
                            if ($_SESSION["perfil"] != "Preceptor") {
                              ...
                              echo'<button class="btn btn-primary btnImprimirInformeCo5" modalidad="'.$value["modalidad"].'" informe="informeco5" periodo="'.$_SESSION['periodo'].'" tabla="quinto" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirInformeCb"><i class="fa fa-print"></i></button>
