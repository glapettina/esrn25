                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                              ...
                              if ($value["estado"] != 0) {
                                ...
                                echo '<td><button class="btn btn-success btn-xs btnActivarAlumno" tabla="cuarto" idAlumno="'.$value["id"].'" estadoAlumno="0">Activado</button></td>';

                            }else{

                                echo '<td><button class="btn btn-danger btn-xs btnActivarAlumno" tabla="cuarto" idAlumno="'.$value["id"].'" estadoAlumno="1">Desactivado</button></td>';
                            }
                          ...
                          echo '<td>
                            ...
                            if ($_SESSION["perfil"] != "Preceptor") {
                               ...
                               echo'<button class="btn btn-primary btnImprimirInformeCo4" modalidad="'.$value["modalidad"].'" informe="informeco4" tabla="cuarto" periodo="'.$_SESSION['periodo'].'" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirInformeCb"><i class="fa fa-print"></i></button>
