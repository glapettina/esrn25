<?php
	...
	class ModeloUsuarios{
		...
		static public function mdlIngresarUsuario($tabla, $datos){
			...
			$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, telefono, usuario, password, perfil, foto) VALUES (:nombre, :telefono, :usuario, :password, :perfil, :foto)");
		...
		static public function mdlEditarUsuario($tabla, $datos){
			...
			$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, telefono = :telefono, password = :password, perfil = :perfil, foto = :foto WHERE usuario = :usuario");
